...
<html lang="en">
    ...
    <body>
        ...
        style="background-color: rgb(194, 234, 188);">
        <div class="container">
    ...
    <!-- Cart -->
    <section class="bg-light h-100" style="background-color: rgb(255, 255, 255);">
            ...
            <div class="col-10">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2">
                        <img src="/Binder.jpeg" alt="Binder" class="img-fluid rounded-3">
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-3">
                        <p class="class lead fw-normal mb-2">Binder</p>
